...
//    if (userType == HuiYuan || userType == GHXTSYQY) {//会员 或者 港航系统水运企业
        ...
        EdgeCollectionModel *menu_2 = [[EdgeCollectionModel alloc]initID:0 imageName:@"wdcb" label:@"我的船舶" userType:userType];
        
        menu_2.url = [NSString stringWithFormat:@"%@/BjAppWeb/page/ShipInfo.html",IPHelper.getDataURL];
        [functionMenuArray addObject:menu_2];

        EdgeCollectionModel *menu_3 = [[EdgeCollectionModel alloc]initID:0 imageName:@"cbdd" label:@"调度信息" userType:userType];
        menu_3.url = [NSString stringWithFormat:@"%@",IPHelper.getDataURL];
        ...
        EdgeCollectionModel *menu_11 = [[EdgeCollectionModel alloc]initID:0 imageName:@"cygl" label:@"船员管理" userType:userType];
        menu_11.url = [NSString stringWithFormat:@"%@",IPHelper.getDataURL];
        [functionMenuArray addObject:menu_11];
        
        EdgeCollectionModel *menu_12 = [[EdgeCollectionModel alloc]initID:0 imageName:@"aqjc" label:@"安全检查" userType:userType];
        menu_12.url = [NSString stringWithFormat:@"%@",IPHelper.getDataURL];
        [functionMenuArray addObject:menu_12];
...
//    }else if(userType == Admin || userType == GHGLBM){  //管理员 或者 交通局用户
        ...
        EdgeCollectionModel *menu_9 = [[EdgeCollectionModel alloc]initID:0 imageName:@"dsjfx" label:@"大数据分析" userType:userType];
        menu_9.url = [NSString stringWithFormat:@"%@",IPHelper.getDataURL];
        [functionMenuArray addObject:menu_9];
        
//    }
    
    EdgeCollectionModel *menu_4 = [[EdgeCollectionModel alloc]initID:0 imageName:@"hahz" label:@"碍航信息" userType:userType];
    menu_4.url = [NSString stringWithFormat:@"%@/BjAppWeb/page/channelInfo.html",IPHelper.getDataURL];
    [functionMenuArray addObject:menu_4];
    
    EdgeCollectionModel *menu_5 = [[EdgeCollectionModel alloc]initID:0 imageName:@"hyxx" label:@"航运信息" userType:userType];
    menu_5.url = [NSString stringWithFormat:@"%@/BjAppWeb/page/transportInfo.html",IPHelper.getDataURL];
    [functionMenuArray addObject:menu_5];
    
    EdgeCollectionModel *menu_8 = [[EdgeCollectionModel alloc]initID:0 imageName:@"bjdt" label:@"北江动态" userType:userType];
    menu_8.url = [NSString stringWithFormat:@"%@/BjAppWeb/page/NewsLists.html",IPHelper.getDataURL];
    
    [functionMenuArray addObject:menu_8];
    
    EdgeCollectionModel *menu_10 = [[EdgeCollectionModel alloc]initID:0 imageName:@"cbgl" label:@"船闸信息" userType:userType];
