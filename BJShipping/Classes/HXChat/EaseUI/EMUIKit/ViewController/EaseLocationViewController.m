...
//    self.navigationItem.leftBarButtonItem = [UIBarButtonItem iteamWithImageNamed:@"back.png" hightLightImageName:@"back.png" target:self action:@selector(popViewControllerAnimated:)];
