...
//   EdgeNickNameOptions *nickOptions = [[EdgeNickNameOptions alloc]init];
//    NSMutableArray *muDataArr = [nickOptions selectnickNameFormTable];
//    NSString *nickName;
//    
//    for (nickName in muDataArr) {
//        
...
//    
    ...
    if ([_model.nickname length] > 0) {
        ...
        NSLog(@"nickname = %@",_model.nickname);
    }
    else{
