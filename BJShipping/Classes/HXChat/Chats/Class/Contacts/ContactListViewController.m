...
//-(EdgeNickNameOptions *)nickOptions{
//    if (!_nickOptions) {
//        _nickOptions = [[EdgeNickNameOptions alloc]init];
//      //  创建数据库
//        [_nickOptions createNickNameDataTable];
////
//    }
//    return _nickOptions;
//}
//
//-(NSMutableArray *)muDataArr{
//    if (!_muDataArr) {
//        _muDataArr = [NSMutableArray array];
//        _muDataArr = [self.nickOptions selectnickNameFormTable];
////        NSLog(@"  _muDataArr = =%lu",(unsigned long)_muDataArr.count);
//    }
//    return _muDataArr;
//}
...
//    }
//    NSLog(@"[[self.dataArray objectAtIndex:(section - 2)] count] = %lu",(unsigned long)[[self.dataArray objectAtIndex:(section - 2)] count]);
...
//            EdgeLog(@"indexPath.row=======1/3 = %@",cell.titleLabel.text);
        }
//        else if (indexPath.row == 2) {//  聊天室
//            cell.avatarView.image = [UIImage imageNamed:@"EaseUIResource.bundle/group"];
//            cell.titleLabel.text = NSLocalizedString(@"title.chatroom",@"chatroom");
////             EdgeLog(@"indexPath.row=======2/3 = %@",cell.titleLabel.text);
//        }
...
//            EdgeLog(@"indexPath.row ============3/3 = %@",cell.titleLabel.text);
        }
        return cell;
...
////         EdgeLog(@"otherPlatformIds = %@",cell.titleLabel.text);
//        return cell;
//        
    }
        else {
...
{
//    NSLog(@"self.navigaton = %@",self.navigationController);
